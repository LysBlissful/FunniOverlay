...
body.src = "../spriteSheets/body.png";
const timer = new Timer(1000 / 60);
timer.tick.add(draw)

const parts = new Map([
   ["clothing", new AnimationManager("../spriteSheets/clothing.png", 4, 1)],
   ["eyeShape", new AnimationManager("../spriteSheets/eyeShapes.png", 4, 1)],
   ["headwear", new AnimationManager("../spriteSheets/headwear.png", 4, 2)],
   ["mouthShape", new AnimationManager("../spriteSheets/mouthShapes.png", 4, 2)],
   ["noseShape", new AnimationManager("../spriteSheets/noseShapes.png", 4, 3)],
   ["shellColor", new AnimationManager("../spriteSheets/shellColor.png", 4, 4)] 
]);
